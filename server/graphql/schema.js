...
`;
const typeDefs = [query, categories, products, manufacturers, details];
const resolvers = _.merge(categoriesResolvers, productsResolvers, manufacturersResolvers, detailsResolvers);
